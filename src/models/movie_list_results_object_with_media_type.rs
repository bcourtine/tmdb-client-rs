...
pub struct MovieListResultsObjectWithMediaType {
...
impl MovieListResultsObjectWithMediaType {
    pub fn new(media_type: String) -> MovieListResultsObjectWithMediaType {
