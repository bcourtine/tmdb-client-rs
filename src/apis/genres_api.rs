...
pub struct GenresApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> GenresApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> GenresApiClient<T> {
        GenresApiClient {
            configuration,
        }
    }
...
impl <T: crate::apis::configuration::HttpClient + 'static> GenresApi for GenresApiClient<T> {
    fn get_all_movie_genres_list(
        &self,
        language: Option<&str>,
    ) -> Result<crate::models::GenresList, Error> {
