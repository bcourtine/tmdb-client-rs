...
pub trait AccountApi {
    fn get_account_favorite_movies_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::MoviePaginated, Error>;
    fn get_account_favorite_tv_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::TvPaginated, Error>;
    fn get_account_rated_movies_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::MoviePaginated, Error>;
    fn get_account_rated_tv_episodes_paginated(&self, account_id: &str, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::TvEpisodesPaginated, Error>;
    fn get_account_rated_tv_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::TvPaginated, Error>;
    fn get_account_watchlist_movies_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::MoviePaginated, Error>;
    fn get_account_watchlist_tv_paginated(&self, account_id: i32, session_id: &str, language: Option<&str>, sort_by: Option<&str>) -> Result<crate::models::TvPaginated, Error>;
    fn get_current_account_details(&self, session_id: &str) -> Result<crate::models::AccountDetails, Error>;
    fn get_current_account_lists_paginated(&self, account_id: i32, session_id: &str, api_key: Option<&str>, language: Option<&str>) -> Result<crate::models::ListsPaginated, Error>;
    fn post_account_favorite(&self, account_id: i32, session_id: &str, content_type: &str, body: Option<crate::models::MediaFavoriteBody>) -> Result<crate::models::InlineResponse401, Error>;
    fn post_account_watchlist(&self, account_id: i32, content_type: &str, session_id: &str, body: Option<crate::models::MediaWatchlistBody>) -> Result<crate::models::InlineResponse401, Error>;
}
