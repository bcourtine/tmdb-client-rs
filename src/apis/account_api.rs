...
pub trait AccountApi {
    ...
    fn post_account_favorite(&self, account_id: i32, session_id: &str, content_type: &str, body: crate::models::MediaFavoriteBody) -> Result<crate::models::InlineResponse401, Error>;
    fn post_account_watchlist(&self, account_id: i32, content_type: &str, session_id: &str, body: crate::models::MediaWatchlistBody) -> Result<crate::models::InlineResponse401, Error>;
}
