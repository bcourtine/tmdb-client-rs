...
pub struct AccountApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> AccountApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> Self {
        AccountApiClient {
            configuration,
        }
    }
...
impl <T: crate::apis::configuration::HttpClient + 'static> AccountApi for AccountApiClient<T> {
    fn get_account_favorite_movies_paginated(
        &self,
        account_id: i32,
        session_id: &str,
