...
pub trait CollectionsApi {
    fn get_collection_details(&self, collection_id: i32, language: Option<&str>) -> Result<crate::models::CollectionObject, Error>;
    fn get_collection_images_list(&self, collection_id: i32, language: Option<&str>) -> Result<crate::models::Images, Error>;
}
