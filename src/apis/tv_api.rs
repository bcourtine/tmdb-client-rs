...
pub struct TVApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> TVApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> TVApiClient<T> {
        TVApiClient {
            configuration,
        }
    }
...
impl <T: crate::apis::configuration::HttpClient + 'static> TVApi for TVApiClient<T> {
    fn delete_tv_rating(
        &self,
        tv_id: i32,
        content_type: &str,
