...
pub struct KeywordsApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> KeywordsApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> KeywordsApiClient<T> {
        KeywordsApiClient {
            configuration,
        }
    }
...
impl <T: crate::apis::configuration::HttpClient + 'static> KeywordsApi for KeywordsApiClient<T> {
    fn get_keyword_details(&self, keyword_id: i32) -> Result<crate::models::Keyword, Error> {
