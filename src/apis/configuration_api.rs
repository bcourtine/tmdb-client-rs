...
pub struct ConfigurationApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> ConfigurationApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> ConfigurationApiClient<T> {
...
impl <T: crate::apis::configuration::HttpClient + 'static> ConfigurationApi for ConfigurationApiClient<T> {
    fn get_configuration(
        &self,
        api_key: Option<&str>,
    ) -> Result<crate::models::Configuration, Error> {
