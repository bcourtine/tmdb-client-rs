...
pub struct SearchApiClient<T: crate::apis::configuration::HttpClient + 'static> {
    configuration: Rc<configuration::Configuration<T>>,
}

impl <T: crate::apis::configuration::HttpClient + 'static> SearchApiClient<T> {
    pub fn new(configuration: Rc<configuration::Configuration<T>>) -> SearchApiClient<T> {
        SearchApiClient {
            configuration,
        }
    }
...
impl <T: crate::apis::configuration::HttpClient + 'static> SearchApi for SearchApiClient<T> {
    fn get_search_collection_paginated(
        &self,
        query: &str,
        language: Option<&str>,
